...
import { Container, Text, Card, Button, Group, Image, Stack, Title, Avatar, SimpleGrid } from '@mantine/core';
...
function Home() {
  return (
    <>
      ...
      <Container>
        <br />
        <Card shadow="sm" padding="lg" radius="md" style={{ maxWidth: 950, margin: 'auto' }}>
          <Group noWrap align="stretch" spacing="xl">
            <Stack>
              <Title order={1}>Where2Eat</Title>
              <Text>
                Smarter food choices, tailored for you. Don't know what to eat? Try and see for yourself!
              </Text>
              <Button variant="filled" size="md" style={{ backgroundColor: 'black', color: 'white', margin: 'auto'}}>
                Explore
              </Button>
              <Image
        ...
        <Card shadow="sm" padding="lg" radius="md" style={{ maxWidth: 950, margin: 'auto' }}>
          <Group noWrap align="stretch" spacing="xl">
            <Stack justify="space-between" style={{ flex: 1, minWidth: 0 }}>
              ...
              <Group grow>
                <Button variant="filled" size="md" style={{ backgroundColor: 'black', color: 'white' }}>
                  Log In
                </Button>
        ...
        <Container my="xl">
          ...
          <SimpleGrid cols={3} spacing="lg" breakpoints={[{ maxWidth: 'md', cols: 1 }]}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Text style={{ marginBottom: '1rem' }}>“Nathaniel Teo Kukubird”</Text>
